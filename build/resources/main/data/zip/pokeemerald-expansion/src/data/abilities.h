const struct Ability gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    [ABILITY_RIPTIDE] =
    {
        ...
        .name = _("RIPTide"),
    #endif
        .description = COMPOUND_STRING("Attacks have a chance to flinch."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_SUN_EATER] =
    {
        ...
        .name = _("SunEater"),
    #endif
        .description = COMPOUND_STRING("Restore HP in Sun."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_DEVILS_PRICE] =
    {
    #if B_EXPANDED_ABILITY_NAMES == TRUE
        .name = _("Devil's Price"),
    #else
        .name = _("DevilsPrice"),
    #endif
        .description = COMPOUND_STRING("Built in Life orb."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_WAIT_AND_BLEED] =
    {
    #if B_EXPANDED_ABILITY_NAMES == TRUE
        .name = _("Wait and Bleed"),
    #else
        .name = _("WaitandBleed"),
    #endif
        .description = COMPOUND_STRING("Gets stronger at half HP."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_THE_WORLD] =
    {
        ...
        .name = _("The World"),
    #endif
        .description = COMPOUND_STRING("Lowers the foe's SpAttack."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_LIKE_A_THUNDER] =
    {
    #if B_EXPANDED_ABILITY_NAMES == TRUE
        .name = _("Like A Thunder"),
    #else
        .name = _("LikeAThunder"),
    #endif
        .description = COMPOUND_STRING("Attacks can Paralyze."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_PUNCHING_BAG] =
    {
        ...
        .name = _("PunchingBag"),
    #endif
        .description = COMPOUND_STRING("Increase attack when hit."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_NIGHT_DANCER] =
    {
        ...
        .name = _("NightDancer"),
    #endif
        .description = COMPOUND_STRING("Dark moves raise speed."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_WHITE_POEM] =
    {
        ...
        .name = _("WhitePoem"),
    #endif
        .description = COMPOUND_STRING("Prevent Stat changes."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_STAINS_OF_TIME] =
    {
    #if B_EXPANDED_ABILITY_NAMES == TRUE
        .name = _("Stains Of Time"),
    #else
        .name = _("StainsOfTime"),
    #endif
        .description = COMPOUND_STRING("Poisons foe on contact."),
    ...
    [ABILITY_CHRONOSTASIS] =
    {
        ...
        .name = _("Chronostasis"),
    #endif
        .description = COMPOUND_STRING("Immune to Para/Flinch."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_KINGSLAYER] =
    {
        ...
        .name = _("Kingslayer"),
    #endif
        .description = COMPOUND_STRING("Increases Attack."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_HEADSTRONG] =
    {
        ...
        .name = _("Headstrong"),
    #endif
        .description = COMPOUND_STRING("Increase recoil moves damage, immune to recoil."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_VANISHING_DAY] =
    {
    #if B_EXPANDED_ABILITY_NAMES == TRUE
        .name = _("Vanishing Day"),
    #else
        .name = _("VanishingDay"),
    #endif
        .description = COMPOUND_STRING("Summons Eclipse."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_TOTALITY] =
    {
        ...
        .name = _("Totality"),
    #endif
        .description = COMPOUND_STRING("Changes form in Eclipse."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
