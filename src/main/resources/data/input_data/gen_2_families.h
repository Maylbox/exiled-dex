...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, ABILITY_SIMPLE, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_BROWN,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_FLUFFY, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_WHITE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_MOTOR_DRIVE, ABILITY_ELECTRIC_SURGE },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_MOXIE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_SAND_FORCE, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_HUSTLE, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_INTIMIDATE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        [SPECIES_EXILED_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_ICE_BODY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Slugma"),
        .cryId = CRY_SLUGMA,
        .natDexNum = NATIONAL_DEX_SLUGMA,
        ...
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = gMonShinyPalette_Slugma, 
        .shinyPalette = gMonPalette_Slugma,
        .iconSprite = gMonIcon_Slugma,
        .iconPalIndex = 0,
        FOOTPRINT(Slugma)
        OVERWORLD(
        ...
        .levelUpLearnset = sExiledSlugmaLevelUpLearnset,
        .teachableLearnset = sExiledSlugmaTeachableLearnset,
        .eggMoveLearnset = sSlugmaEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_EXILED_MAGCARGO}),
    },

    [SPECIES_EXILED_MAGCARGO] =
    {
        .baseHP        = 94,
        .baseAttack    = 113,
        .baseDefense   = 90,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_ICE_BODY, ABILITY_GLACIAL_TOXINS },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magcargo"),
        .cryId = CRY_MAGCARGO,
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = gMonShinyPalette_Magcargo, 
        .shinyPalette = gMonPalette_Magcargo,
        .iconSprite = gMonIcon_Magcargo,
        .iconPalIndex = 0,
        FOOTPRINT(Magcargo)
        OVERWORLD(
        ...
        .levelUpLearnset = sExiledMagcargoLevelUpLearnset,
        .teachableLearnset = sExiledSlugmaTeachableLearnset,
    },
